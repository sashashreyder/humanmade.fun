          ...
          <div className="relative z-10 flex flex-wrap justify-center sm:justify-between items-center gap-12 sm:gap-8 ml-5 sm:ml-15 mr-0 sm:mr-15 mb-15">
            <a href="https://www.paffi.it/" target="_blank" rel="noopener noreferrer">
              <div className="relative group w-20 h-20">
                <div className="w-full h-full bg-gradient-to-r from-pink-400 via-purple-500 to-indigo-400 animate-pulse rounded-full flex items-center justify-center">
                  <img src="/assets/free-icon-abstract-art-14698180.png" alt="abstract art" className="w-12 h-12" />
                </div>
                <span className="absolute inset-0 flex items-center justify-center text-white text-sm font-semibold opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-110 transition-all duration-300 pointer-events-none">
                  EMOTIONAL
                </span>
              </div>
            </a>
            ...
            <a href="https://tryboredcow.com/" target="_blank" rel="noopener noreferrer">
              <div className="relative group w-20 h-20">
                <div className="w-full h-full bg-gradient-to-r from-yellow-500 via-orange-600 to-red-600 animate-pulse rounded-full flex items-center justify-center">
            ...
            <a href="https://immersive-g.com/" target="_blank" rel="noopener noreferrer">
              <div className="relative group w-20 h-20">
                <div className="w-full h-full bg-gradient-to-r from-teal-500 via-blue-500 to-indigo-600 animate-pulse rounded-full flex items-center justify-center">
